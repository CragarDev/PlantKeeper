        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Plant Keeper - landing</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                    ...
                    <body>
                        ...
                        <div class="container text-center">
                            ...
                            <div>
                                ...
                                <a class="btn btn-primary mt-4" href="/dashboard">Start Planting!</a>
                            </div>
                            <!-- Page Title END -->
                            ...
                            <!-- <div>
                                <h1 class="bg-primary text-light ps-5">Welcome <span
                                        class="text-primary ">${user.userName}</span>, to the Plant Keeper Home</h1>
                            </div> -->
