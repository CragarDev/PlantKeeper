        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Plant Keeper - Create One</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                        ...
                        <div class="container text-center">
                            ...
                            <div>
                                <h1 class="bg-primary text-light ps-5">Welcome <span
                                        class="text-primary ">${user.firstName}</span>, to the Plant Keeper Create a
                                    Plant
                                    Page</h1>
                            </div>
                            ...
                            <div
                                ...
                                <form:form action="/createNewPlant" method="post" modelAttribute="plant">
                                    ...
                                    <input type="submit" value="Add New Plant" class="btn btn-warning float-start" />
                                    <!-- == Cancel button == -->
                                    <p class="w-100"></p>
