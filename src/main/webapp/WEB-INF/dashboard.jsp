        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Plant Keeper - dashboard</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                        ...
                        <div class="container text-center">
                            ...
                            <div>
                                <h1 class="bg-primary text-light ps-5">Welcome <span
                                        class="text-primary ">${user.firstName}</span>, to the Plant
                                    Keeper Dashboard
                                </h1>
                            </div>
                            ...
                            <div>
                                <div>
                                    <h1 class="bg-primary text-success ps-5">All Plants</h1>
                                </div>
                                <p class="w-100"></p>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="plant" items="${plants}">
                                                <tr>
                                                    ...
                                                    <td scope="row">
                                                        <p class="text-center">
                                                            <!-- showing both first and last name -->
                                                            <a href="/oneUserDetails/${plant.user.id}">
                                                                <c:out
                                                                    value="${plant.user.firstName} ${plant.user.lastName}">
                                                                </c:out>
                                                            </a>
                                                        </p>
                                                    </td>
